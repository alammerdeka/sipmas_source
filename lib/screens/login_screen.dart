              ...
              children: [
                ...
                Container(
                  child: TextFormField(
                      ...
                      obscureText: true,
                      decoration:
                          fieldPrefIcon(Icon(Icons.password), 'Password')),
                  decoration: BoxDecoration(
                    color: Colors.grey.shade100,
                    borderRadius: BorderRadius.circular(10),
                  ),
                        ...
                        onPressed: () async {
                          ...
                          if (emailController.text.isEmpty ||
                            ...
                            if (loginAuth!.status == false) {
                              ...
                              loginAuth != null
                                  ? showError(loginAuth.message!)
                                  : null;
                              loginAuth.identity != null
                                  ? showError(loginAuth.identity!)
                                  : null;
                            } else {
                              showSuccess('Login berhasil');
                              userProvider.user = loginAuth;
                              Navigator.of(context).push(MaterialPageRoute(builder: (_)=>ValidasiScreen()));
