...
class _KadinHomeScreenState extends State<KadinHomeScreen> {
  getInit() async {
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  buttonFitur(Icon(Icons.person), 'Pengguna', () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                  ...
                  buttonFitur(Icon(Icons.insert_drive_file), 'Surat', () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DataSuratScreen()));
                  }),
                  buttonFitur(Icon(Icons.newspaper), 'Berita',
                      () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => DataBeritaScreen()));
                  }),
                ],
              ),
            ),
