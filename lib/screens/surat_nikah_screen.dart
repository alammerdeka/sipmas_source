...
class _SuratNikahScreenState extends State<SuratNikahScreen> {
  ...
  TextEditingController suratAlasanController = TextEditingController();
  TextEditingController suratPersyaratanController = TextEditingController();
              ...
              child: ListView(
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(bottom: 12.0),
                    child: TextFormField(
                      controller: suratAlasanController,
                      keyboardType: TextInputType.text,
                  ...
                  Container(
                    margin: EdgeInsets.only(bottom: 12.0),
                    child: TextFormField(
                      controller: suratPersyaratanController,
                      keyboardType: TextInputType.text,
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextFormField(
                    controller: suratPersyaratanController,
                    keyboardType: TextInputType.text,
                    decoration: fieldPrefIcon(Icon(Icons.people), ''),
                  ),
                  decoration: BoxDecoration(
                    color: Colors.grey.shade100,
                    borderRadius: BorderRadius.circular(10),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              SizedBox(height: 20),
              Text('Buat Surat Keterangan Belum Nikah'),
              SizedBox(height: 20),
              CustomTabbar(
